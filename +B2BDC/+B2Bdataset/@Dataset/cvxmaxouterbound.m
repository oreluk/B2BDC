function [maxout,maxSensitivity] = cvxmaxouterbound(obj,QOIobj,frac)
...
cvx_end
maxout = cvx_optval;
maxSensitivity.expl = -lamlb;
maxSensitivity.expu = lamub;
maxSensitivity.varl = -lamxl;
maxSensitivity.varu = lamxu;
