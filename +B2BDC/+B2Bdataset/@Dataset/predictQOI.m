...
if B2Bopt.Display
   ...
   disp(['Minimum value of QOI is within: [' num2str(dy*minout+my) ' ' num2str(dy*minin+my) ']'])
   disp(['Maximum value of QOI is within: [' num2str(dy*maxin+my) ' ' num2str(dy*maxout+my) ']'])
end
